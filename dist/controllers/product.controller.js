...
exports.createProduct = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const uploadedImages = await (0, uploadAndDeleteImage_1.uploadMedia)(productImages);
...
exports.editProduct = (0, catchAsync_1.default)(async (req, res, next) => {
...
exports.deleteProduct = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const userAccount = await user_model_1.Seller.findByIdAndUpdate(user.id, {
...
exports.fetchAllProducts = (0, catchAsync_1.default)(async (req, res, next) => {
    const { search, category, storeId, sellerId, location, minPrice, maxPrice, sort = "createdAt", order = "desc", limit = 10, page = 1, ...filters } = req.query;
    ...
    // Fetch products
    const findProduct = await product_model_1.default.find(query)
        .select("-isDeleted")
...
exports.deleteAllProducts = (0, catchAsync_1.default)(async (req, res, next) => {
    const findProduct = await product_model_1.default.deleteMany();
    return (0, AppResponse_1.default)(res, "All Product fetched successfully", 200, findProduct);
});
exports.getSingleProduct = (0, catchAsync_1.default)(async (req, res, next) => {
    const { productId } = req.params;
    if (!productId) {
...
exports.fetchAllMyProducts = (0, catchAsync_1.default)(async (req, res, next) => {
    const user = req.user;
    const productsWithDetails = await product_model_1.default.aggregate([
...
exports.newArrivals = (0, catchAsync_1.default)(async (req, res, next) => {
    try {
        const newArrivals = await product_model_1.default.find({ isDeleted: false })
            .sort({ createdAt: -1 })
            .limit(8)
...
exports.rateStore = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const seller = await user_model_1.Seller.findById(sellerId);
...
exports.SearchForProduct = (0, catchAsync_1.default)(async (req, res, next) => {
